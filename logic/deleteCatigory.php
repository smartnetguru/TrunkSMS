...
$phoneNo = $_SESSION['phoneNo']; //session variable
	...
	if(isset($_POST['catid'], $phoneNo )){
	$id = (int) $_POST['catid']; 
	$sql = "DELETE FROM TRUNKphoneBookCat WHERE `id` = $id";
