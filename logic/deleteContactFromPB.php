...
$phoneNo = $_SESSION['phoneNo']; //session variable
	...
	if(isset($_POST['contactID'], $phoneNo )){
	$id = (int) $_POST['contactID']; 
	$sql = "DELETE FROM TRUNKphoneBook WHERE `id` = $id";
	$result = mysql_query($sql);
		if($result){
				...
				echo "Entry was <strong>successfuly</strong> deleted.</p>";
				...
				echo "<strong>Alert:</strong> Oops! Error deleting Contact info.</p>";
				echo "<div  class = \"back\"><a style = \"text-decoration: none;\" href = \"./\"   onClick = \"getSMSForm(); return false;\">back</a></div>";
				echo "</div></div>";
/*
		echo "<div id = \"failure\">";
		echo "Oops! Error deleting Contact info";
