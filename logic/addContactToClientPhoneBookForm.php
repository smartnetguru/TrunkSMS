...
$phoneNo = $_SESSION['phoneNo']; //session variable
	...
	if(isset($_POST['submit'], $_POST['phoneNo'], $_POST['contactName'], $_POST['category'], $phoneNo)){
...
echo "<div class=\"ui-state-error ui-corner-all\" style=\"padding: 0 .7em;  margin-top: 20px; \">";
	...
	echo "<div  class = \"back\"><a style = \"text-decoration: none;\" href = \"./\" onClick = \"getContactForm();return false;\">back</a></div>";	*/
		...
		$num = mysql_num_rows($result);
			...
			$sql = "INSERT INTO TRUNKphoneBook (`id`, `phoneNo`, `number`, `name`, `category`) VALUES (NULL, '$phoneNo', '$number', '$name', '$catID');";
			$result = mysql_query($sql);
				if($result){
				echo "<div class=\"ui-widget\">";
				...
				echo "Entry was <strong>Successfuly</strong> added.</p>";
				echo "<div  class = \"back\"><a style = \"text-decoration: none;\" href = \"./\" onClick = \"getphoneBook();return false;\">Refresh PhoneBook</a> | <a style = \"text-decoration: none;\" href = \"./\" onClick = \"getSMSForm(); return false;\">Send SMS</a></div>";
				echo "</div></div>";
				/*
			echo "<div id = \"success\">";
				echo "Entry was Successfuly added";
