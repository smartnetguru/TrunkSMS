...
$phoneNo = $_SESSION['phoneNo'];
	...
	if(isset($_POST['submit'], $_POST['catego'])){
	...
	echo "<div  class = \"back\"><a style = \"text-decoration: none;\" href = \"./\" onClick = \"getContactForm();return false;\">back</a></div>";	*/
		...
		$num = mysql_num_rows($result);
			...
			$sql = "INSERT INTO TRUNKphoneBookCat (`id`, `phoneNo`, `category`) VALUES (NULL, '$phoneNo', '$category')";
			$result = mysql_query($sql);
				if($result){
				...
				echo "Category was <strong>successfuly</strong> added.</p>";
				echo "<div  class = \"back\"><a style = \"text-decoration: none;\" href = \"./\" onClick = \"getContactForm();return false;\">back</a></div>";
				echo "</div></div>";

/*
			echo "<div id = \"success\">";
				echo "Category was successfuly added";
...
echo "<div class=\"ui-state-error ui-corner-all\" style=\"padding: 0 .7em;  margin-top: 20px; \">";
				echo "<p><span class=\"ui-icon ui-icon-alert\" style=\"float: left; margin-right: .3em;\"></span>"; 
				echo "<strong>Alert:</strong> The provided Category Exists.</p>";
				echo "<div  class = \"back\"><a style = \"text-decoration: none;\" href = \"./\" onClick = \"getContactForm();return false;\">back</a></div>";	
echo "</div></div>";
	/*
			echo "<div id = \"failure\">";
			echo "The provided Category Exists.";
			echo "</div> <!-- end failure -->";
			echo "<div  class = \"back\"><a style = \"text-decoration: none;\" href = \"./\" onClick = \"getContactForm();return false;\">back</a></div>";	*/
