...
OpenDB();
$sqltext="select id, org, phoneNo, toNum, mesg, fromNa, units, statusMsg, date, sent from TRUNKsent";
CloseApp();
...
Rico.onLoad( function() {
  ...
  var grid_options = {
    ...
    columnSpecs:  [,{filterUI:'t',width:150},{filterUI:'t',width:150},,,,,,,{filterUI:'s',width:150}]
  };
...
<thead>
  <tr id='ex3_main'>
  	  <th>id</th>
	  <th class='ricoFrozen'>Org Name</th>
	  <th class='ricoFrozen'>Phone No</th>
	  <th>Sent To</th>
	  <th>Message</th>
	  <th>SMS Name</th>
	  <th>Units</th>
