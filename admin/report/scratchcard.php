...
OpenDB();
$sqltext="select serialNo,pincode,used,phone,units,date,identifyer from TRUNKrecharging";
CloseApp();
...
Rico.onLoad( function() {
  ...
  var grid_options = {
    ...
    columnSpecs:  [{filterUI:'t',width:150},{filterUI:'t',width:150},{filterUI:'s',width:100},
...
<thead>
  <tr id='ex3_main'>
	  <th class='ricoFrozen'>Serial Number</th>
	  <th>Pin Code</th>
	  <th>Used</th>
	  <th>Phone Number</th>	  
	  <th>Units</th>
